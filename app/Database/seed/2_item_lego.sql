...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Lion Knights'' Castle (10305)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Wolfpack Tower (6075)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Wolfpack Renegades (6038)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Battering Ram (6062)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'King''s Castle (6080)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'City Square (60097)' LIMIT 1),
 '60097', 'City Square', 'LEGO City Set 60097 mit 1.683 Teilen und 14 Minifiguren.', '60097', 'City / Town', 1683, '2015-06-01', 199.99, 2),
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Fire Station (60004)' LIMIT 1),
 '60004', 'Fire Station', 'LEGO City Set 60004 mit 753 Teilen und fünf Minifiguren.', '60004', 'City / Fire', 753, '2013-01-01', 119.99, 3),
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Train Station (60335)' LIMIT 1),
 '60335', 'Train Station', 'LEGO City Set 60335 mit 907 Teilen und sechs Minifiguren.', '60335', 'City / Trains', 907, '2022-06-01', 119.99, 5),
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Police Station (60246)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Police Station (60047)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Police Station (60316)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Galaxy Explorer (10497)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Explorien Starship (6982)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Space Cruiser and Moonbase (928)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Eldorado Fortress (6276)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Eldorado Fortress (10320)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Black Seas Barracuda (6285)' LIMIT 1),
 '6285', 'Black Seas Barracuda', 'LEGO Pirates Set 6285 mit 909 Teilen und acht Minifiguren.', '6285', 'Pirates', 909, '1989-01-01', 409.99, 1),
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Pirates of Barracuda Bay (21322)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Medieval Market Village (10193)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Medieval Town Square (10332)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Eiffel Tower (10181)' LIMIT 1),
...
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Eiffel Tower (10307)' LIMIT 1),
 '10307', 'Eiffel Tower', 'LEGO Icons Set 10307 mit 10.001 Teilen.', '10307', 'Icons / Landmarks', 10001, '2022-11-25', 629.99, 2),
((SELECT `id` FROM `catalog` WHERE `brand_id` = @lego_brand_id AND `name` = 'Medieval Blacksmith (21325)' LIMIT 1),
